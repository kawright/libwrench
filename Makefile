...
build/tests/test_wrench: wrench.c wrench.h tests/test_wrench.c tests/test_wrench.h tests/test_ASSERTEQ.c tests/test_ASSERTFALSE.c tests/test_ASSERTGT.c tests/test_ASSERTGTEQ.c tests/test_ASSERTLT.c tests/test_ASSERTLTEQ.c tests/test_ASSERTNEQ.c
	@ echo ========================================
