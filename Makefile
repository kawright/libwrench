...
build/tests/test_wrench: wrench.c wrench.h tests/test_wrench.c tests/test_wrench.h tests/test_ASSERTEQ.c tests/test_ASSERTFALSE.c tests/test_ASSERTGT.c tests/test_ASSERTGTEQ.c tests/test_ASSERTLT.c tests/test_ASSERTLTEQ.c
	@ echo ========================================
	...
	gcc -o build/tests/test_wrench build/tests/obj/wrench.o build/tests/obj/test_wrench.o build/tests/obj/test_ASSERTEQ.o build/tests/obj/test_ASSERTFALSE.o build/tests/obj/test_ASSERTGT.o build/tests/obj/test_ASSERTGTEQ.o build/tests/obj/test_ASSERTLT.o build/tests/obj/test_ASSERTLTEQ.o
	@ echo Finished!
